...
(function () {
    ...
    function onayKutusu(k, hedef) {
        ...
        var vazgec=document.createElement('button');vazgec.type='button';vazgec.textContent='Vazgeç';var gonder=document.createElement('button');gonder.type='button';gonder.textContent=hedef==='ENABLED'?'Yayına al':(hedef==='REMOVED'?'Kaldır':'Duraklat');gonder.style.marginLeft='8px';
